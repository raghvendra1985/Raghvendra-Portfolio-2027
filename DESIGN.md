...
The system rejects cream-as-personality, purple-glow kits, dashboard shells, and generic “premium” restyles. Frozen surfaces (Homepage, About, Contact, Work Index, System, featured case-study interiors, nav, footer, Ask, charms, tokens) are the identity source of truth. Open surfaces refine hierarchy and finish inside that identity.
