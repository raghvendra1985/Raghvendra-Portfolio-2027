...
const QUERY_ALIASES: [string, string][] = [
  ...
  ["start", "flagship crowley ghostwriter nye rapipay"],
  ["product direction", "product-direction eqty sagacito"],
  ["brand and web", "brand-and-web viralops pacific 2886"],
  ["complex systems", "complex-systems crowley shuttl hempel obzrv"],
  ["enterprise leadership", "enterprise-leadership nye rapipay verizon"],
  ["freight", "crowley maritime quote logistics"],
  ["quoting", "crowley freight quote wizard"],
  ["crowley", "crowley maritime freight quote customs"],
