      ...
      <div className="mx-auto max-w-[1440px]">
        <div className="flex flex-col items-start justify-between gap-10 lg:flex-row lg:items-end">
          <div data-reveal-item>
            <p className="font-mono-label text-ink-soft">/ Secret Products</p>
            <h2 className="mt-4 max-w-xl type-h2">
          ...
          >
            <div>
              <p className="font-mono-label text-ink-soft">{count} products</p>
              <p className="mt-2 font-mono-label text-ink-soft">{from} onwards</p>
            </div>
            <Link
              href="/products"
              data-cursor="Open"
