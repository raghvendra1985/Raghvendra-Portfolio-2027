...
export const teachingPage: TeachingPage = {
  ...
  heroGallery: [
    ...
    {
      src: "/assets/testimonials/workshop-scenes/uid-workshop-01.jpg",
      alt: "UID workshop facilitation in a classroom",
      venue: "UID workshop",
      caption: "UID workshop — facilitation at the front of the room",
      width: 1920,
      height: 1440,
    },
    {
